define(['Util', 'ConstantPoolInfo', 'Primitives'],
  function (Util, ConstantPoolInfo, Primitives) {
    ...
    ConstantPool.prototype.getUTF8Info = function(index) {
      ...
      Util.assert(this[index].tag == ConstantPoolInfo.tags.UTF8);
    ...
    ConstantPool.prototype.getClassInfo = function(index) {
      if (index === 0) return undefined;
      if (!(index in this)) Util.assert(false);
      Util.assert(this[index].tag == ConstantPoolInfo.tags.CLASS);
    ...
    function ConstantClassInfo(nameIndex) {
      Util.inherits(this,ConstantPoolInfo, ConstantPoolInfo.tags.CLASS);
    ...
    function ConstantRefInfo(refType, classIndex, nameAndTypeIndex) {
      Util.inherits(this,ConstantPoolInfo, refType);
      ...
      this.resolveReferences = function(constantPool) {
        ...
        Util.assert(this.nameAndType.tag == ConstantPoolInfo.tags.NAMEANDTYPE);
      };
    ...
    function ConstantStringInfo(stringIndex) {
      Util.inherits(this,ConstantPoolInfo, ConstantPoolInfo.tags.STRING);
    ...
    function ConstantNameAndTypeInfo(nameIndex, descriptorIndex) {
      Util.inherits(this,ConstantPoolInfo, ConstantPoolInfo.tags.NAMEANDTYPE);
      this.nameIndex = nameIndex;
    ...
    function ConstantUTF8Info(length, string) {
      Util.inherits(this,ConstantPoolInfo, ConstantPoolInfo.tags.UTF8);
      this.length = length;
      this.string = string;
