...
require(['VM', 'console', 'JavaClassReader', 'Class', 'Util'],
    function (VM, Console, JavaClassReader, Class, Util) {
        /**
        ...
        function suppressBackspace(evt) {
            ...
            if ((evt.keyCode === 8 || evt.keyCode === Console.specialCharacters.UP || evt.keyCode === Console.specialCharacters.DOWN ||
                evt.keyCode === Console.specialCharacters.END || evt.keyCode === Console.specialCharacters.HOME || evt.keyCode === 191) && 
