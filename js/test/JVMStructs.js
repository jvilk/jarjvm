/**
 * Defines all of the structs inside the JVM.
 */
define(['Struct'],
  function(Struct) {
    JVMStructs = {};

    JVMStructs.defineStructs = function() {
      //
      // CONSTANT POOL
      //
      /*JVMStructs.cp_info = new Struct("cp_info",
        "u1 tag;u1 info[];"
      );*/

      JVMStructs.classinfo = new Struct("CONSTANT_Class_info",
        "u1 tag;u2 name_index;"
      );

      JVMStructs.fieldref = new Struct("CONSTANT_Fieldref_info",
        "u1 tag;u2 class_index;u2 name_and_type_index;"
      );

      JVMStructs.methodref = new Struct("CONSTANT_Methodref_info",
         "u1 tag;u2 class_index;u2 name_and_type_index;"
      );

      JVMStructs.interfacemethodref = new Struct("CONSTANT_InterfaceMethodref_info",
        "u1 tag;u2 class_index;u2 name_and_type_index;"
      );

      JVMStructs.stringinfo = new Struct("CONSTANT_String_info",
         "u1 tag;u2 string_index;"
      );

      JVMStructs.intinfo = new Struct("CONSTANT_Integer_info",
        "u1 tag;u4 bytes; "
      );

      JVMStructs.floatinfo = new Struct("CONSTANT_Float_info",
        "u1 tag;u4 bytes; "
      );

      JVMStructs.longinfo = new Struct("CONSTANT_Long_info",
        "u1 tag;u4 high_bytes;u4 low_bytes;"
      );

      JVMStructs.doubleinfo = new Struct("CONSTANT_Double_info",
        "u1 tag;u4 high_bytes;u4 low_bytes;"
      );

      JVMStructs.nameandtype = new Struct("CONSTANT_NameAndType_info",
        "u1 tag;u2 name_index;u2 descriptor_index;"
      );

      JVMStructs.utf8 = new Struct("CONSTANT_Utf8_info",
        "u1 tag;u2 length;utf8 bytes;"
      );

      //
      // FIELD_INFO
      //
      JVMStructs.fieldinfo = new Struct("field_info",
