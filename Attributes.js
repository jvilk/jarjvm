define(['Util', 'ByteCode', 'Instruction', 'ConstantPoolInfo'],
    function(Util, ByteCode, Instruction, ConstantPoolInfo) {
    Attribute.makeAttributes = function(javaClassReader, attributesCount) {
        var attributes = [];
    ...
    function GenericAttribute(javaClassReader, attributeNameIndex) {
        Util.inherits(this, Attribute, javaClassReader, attributeNameIndex);
    ...
    function SourceFileAttribute(javaClassReader, attributeNameIndex) {
        Util.inherits(this, Attribute, javaClassReader, attributeNameIndex);
        Util.assert(this.attributeLength == 2);
    ...
    function CodeAttribute(javaClassReader, attributeNameIndex) {
        ...
        for (i = 0; i < this.codeLength; ) {
            ...
            switch(instr) {
                ...
                case ByteCode.codes.putstatic:
                    ...
                    Util.assert(field.tag == ConstantPoolInfo.tags.FIELDREF);
                ...
                case ByteCode.codes.invokeinterface:
                    ...
                    Util.assert(intMeth.tag == ConstantPoolInfo.tags.INTERFACEMETHODREF);
                ...
                case ByteCode.codes.invokevirtual:
                    ...
                    Util.assert(method.tag == ConstantPoolInfo.tags.METHODREF);
                ...
                case ByteCode.codes.ldc:
                    ...
                    Util.assert(constant.tag == ConstantPoolInfo.tags.INTEGER ||
                ...
                case ByteCode.codes.ldc2_w:
                    index = javaClassReader.getUintField(2);
                    constant = CONSTANTPOOL[index];
                    Util.assert(constant.tag == ConstantPoolInfo.tags.DOUBLE ||
        ...
        Util.assert(i == this.codeLength);
        Util.assert(javaClassReader.index - oldIndex == this.codeLength);
        ...
        this.attributeInfo = Attribute.makeAttributes(javaClassReader, this.attributesCount);
