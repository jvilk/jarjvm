define(['Util'],
  function(Util) {
    ...
    function Integer(value){
      require('Util').inherits(this, Primitive, Data.type.INTEGER, value & 0xFFFFFFFF); //Whatever the value is make it a 32bit signed int
    }
    ...
    function Byte(value){
      require('Util').inherits(this, Primitive, Data.type.BYTE, value & 0xFF);
    }
    ...
    function Bool(value){
      require('Util').inherits(this, Primitive, Data.type.BOOLEAN, value & 0x1);
    }
    ...
    function Char(value){
      require('Util').inherits(this, Primitive, Data.type.CHAR, value & 0xFF);
    }
    ...
    function Double(value){
      require('Util').inherits(this, Primitive, Data.type.DOUBLE, value);
    }
    ...
    function Float(value){
      require('Util').inherits(this, Primitive, Data.type.FLOAT, value);
    }
    ...
    function Short(value){
      require('Util').inherits(this, Primitive, Data.type.SHORT, value & 0xFFFF);
    }
